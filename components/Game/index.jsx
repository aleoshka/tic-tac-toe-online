...
export const Game = () => {
  const { cells, currentStep, winnerSeq, winnerSymbol, isDraw, handleCellClick, handleResetClick } =
    useGameState();

  return (
    <div className={"flex flex-col items-center w-72 mx-auto my-24 p-5 border border-black"}>
